...
import { ArrowLeft, Users, Calendar, DollarSign, CheckCircle } from 'lucide-react';
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-2 text-2xl font-bold">{currencySymbol}{(referredUsers.data.reduce((total, user) => total + getTotalCommission(user), 0) || 0).toFixed(2)}</p>
                </div>
