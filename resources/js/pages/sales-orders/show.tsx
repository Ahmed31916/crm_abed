            ...
            <div className="mx-auto space-y-6">
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-2xl font-bold text-green-600 leading-none">{formatCurrency(salesOrder.total_amount)}</h3>
                                </div>
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-2xl font-bold text-blue-600 leading-none">{salesOrder.products?.length || 0}</h3>
                                </div>
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <h3 className="mt-2 text-lg font-bold text-orange-600 leading-tight">{formatDate(salesOrder.delivery_date)}</h3>
                                </div>
                ...
                <Card className="shadow-sm">
                    <CardHeader className="bg-gray-50 border-b">
                        <CardTitle className="text-lg font-semibold">{t('Sales Order Information')}</CardTitle>
                    </CardHeader>
                    <CardContent className="p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {salesOrder.account && (
                                <div className="p-6 bg-green-50 rounded-xl border border-green-200 hover:shadow-md transition-shadow">
                                    ...
                                    <Link
                                        href={route('accounts.show', salesOrder.account.id)}
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div className="flex-1">
                                        <form onSubmit={(e) => {
                                            e.preventDefault();
                                            if (newComment.trim()) {
                                                router.post(route('sales-orders.comments.store', salesOrder.id), {
                                                    comment: newComment
                                                }, {
                                                    preserveScroll: true,
                                                                            ...
                                                                            {editingComment === activity.id ? (
                                                                                <div className="flex gap-2">
                                                                                    ...
                                                                                    <Button
                                                                                        size="sm"
                                                                                        onClick={() => {
                                                                                            router.put(route('sales-orders.comments.update-activity', { salesOrder: salesOrder.id, activity: activity.id }), {
